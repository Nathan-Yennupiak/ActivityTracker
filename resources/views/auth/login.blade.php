...
<div class="login-card">
    ...
    <p class="login-subtitle">Sign in to your ActivityTracker account</p>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="login-form-group">
            ...
            <div class="login-input-container">
                <input type="email" id="email" name="email" class="login-input" value="{{ old('email') }}" required autofocus>
            </div>
        </div>
        ...
        <div class="login-form-group">
            ...
            <div class="login-input-container">
                ...
                <button type="button" class="login-eye-btn" onclick="togglePassword()" aria-label="Toggle password visibility">
